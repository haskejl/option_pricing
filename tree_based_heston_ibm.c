...
const double theta = 0.9345938;
const double omega = 4.13415;
const double rho = 0.0;
const double r = 0.0343;
const double T = 42.f/252.f;
const double V_0 = 0.054756; //0.234^2
//const double V_0 = 0.150875534;
...
int main() {
	...
	const double E[] = {65.f, 70.f, 80.f, 85.f, 95.f}; 
